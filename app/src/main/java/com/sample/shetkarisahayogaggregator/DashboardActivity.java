...
import com.sample.shetkarisahayogaggregator.DashboardActivities.FarmerActivity;
import com.sample.shetkarisahayogaggregator.DashboardActivities.MyDemandsActivity;
import com.sample.shetkarisahayogaggregator.DashboardActivities.ComplaintActivity;
import com.sample.shetkarisahayogaggregator.DashboardActivities.CropPricesActivity;
import com.sample.shetkarisahayogaggregator.DashboardActivities.IdentityActivity;
import com.sample.shetkarisahayogaggregator.DashboardActivities.MyDealsActivity;
import com.sample.shetkarisahayogaggregator.DashboardActivities.UpdateCropsActivity;
...
public class DashboardActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button_identity:
                FirebaseDatabase.getInstance().getReference("Aggregator").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String businessType = dataSnapshot.child(mobileNumber).child("businessType").getValue(String.class);
                        String demandingCrops = dataSnapshot.child(mobileNumber).child("demandingCrops").getValue(String.class);
                        ...
                        intent.putExtra("demandingCrops", demandingCrops);
            ...
            case R.id.farmers:
                startActivity(new Intent(getApplicationContext(), FarmerActivity.class).putExtra("mobileNumber", mobileNumber));
                break;
            ...
            case R.id.my_demands:
                startActivity(new Intent(getApplicationContext(), MyDemandsActivity.class).putExtra("mobileNumber", mobileNumber));
                break;
